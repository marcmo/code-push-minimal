declare module 'react-native-navigation' {
  ...
  export interface SnackbarConfig {
    text: string;
    actionText?: string;
    actionId?: string; // Mandatory if you've set actionText
    actionColor: string; // optional
    textColor: string; // optional
    backgroundColor: string; // optional
    duration: 'short' | 'long' | 'indefinite'; // default is `short`. Available options: short, long, indefinite
  }
  ...
  export interface LightBox {
    ...
    style?: {
      ...
      tapBackgroundToDismiss: boolean; // dismisses LightBox on background taps (optional)
    };
  }
  ...
  export class Navigation {
    ...
    static showSnackbar(params: SnackbarConfig): any;
  ...
  export interface Navigator {
    ...
    showSnackbar(params: SnackbarConfig): any;
